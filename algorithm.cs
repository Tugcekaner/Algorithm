...
namespace alistirma_cs
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write("Tek mi çift mi olduğu kontrol edilecek sayıyı giriniz : ");
            //int say = int.Parse(Console.ReadLine());

            //if (say % 2 == 0)
            //{
            //    Console.WriteLine($"Girilen {say} sayısı çift bir sayıdır.");
            //}
            //else
            //{
            //    Console.WriteLine($"Girilen {say} sayısı tek bir sayıdır. ");
            //}

            //---------------------------------------------------------------------------------------------------------------//

            // 2. Girilen sayının pozitif mi negatif mi olduğunu bulan program.

            //Console.Write("Pozitif-negatifliğine bakılacak sayıyı giriniz : ");
            //int say = int.Parse(Console.ReadLine());

            //if (say > 0)
            //{
            //    Console.WriteLine($"Girilen {say} sayısı pozitif bir sayıdır.");
            //}
            //else if (say == 0)
            //{
            //    Console.WriteLine($"Girilen {say} sayısı 0' a eşittir yani nötrdür.");
            //}
            //else
            //{
            //    Console.WriteLine($"Girilen {say} sayısı negatif bir sayıdır.");
            //}

            //---------------------------------------------------------------------------------------------------------------//

            // 3. Kullanıcıdan alınan iki sayının toplamını, çarpımını ve çıkartmasını bulan program.
            ...
            //Console.Write($"{say1} + {say2} = {toplam}\n{say1} * {say2} = {carpim}\nfarkları = {fark}");

            //---------------------------------------------------------------------------------------------------------------//

            // 4. Verilen sayıların toplamı kaçtır? sayilar = [1,5,89,74,56,13,27,75,46]

            //int[] dizi = new int[] { 1, 5, 89, 74, 56, 13, 27, 75, 46 };
            //int toplam = 0;
            //for (int i = 0; i < dizi.Length; i++) { toplam += dizi[i];}
            //Console.WriteLine($"Verilen sayıların toplamı : {toplam}");

            //---------------------------------------------------------------------------------------------------------------//

            // 5. Verilen sayıların ortalaması kaçtır? sayilar = [1,5,89,74,56,13,27,75,46]

            //int[] sayilar = new int[] { 1, 5, 89, 74, 56, 13, 27, 75, 46 };
            //int toplam = 0;
            //int orta = 0;
            ...
            //    toplam += sayilar[i];
            //}
            //orta = toplam / sayilar.Length;
            //string say = null;
            //for (int i = 0;i < sayilar.Length; i++)
            //{
            //    say += (sayilar[i].ToString())+" ";
            //}
            //Console.WriteLine($"Verilen {say} dizisindeki sayıların ortalaması : {orta}");

            //---------------------------------------------------------------------------------------------------------------//

            // 6. Verilen sayıların çift olanlarının toplamı kaçtır? sayilar = [1,5,89,74,56,13,27,75,46]
            ...
            //    faktor *= i;
            //}
            //Console.WriteLine($"Girilen {say} sayısının faktöriyeli : {faktor}");

            //---------------------------------------------------------------------------------------------------------------//

            // 8. Verilen iki sayının arasındaki sayıları yazdırın.
            ...
            //else if(say1==say2) 
            //{
            //    Console.Write("Girilen sayılar eşit olamaz. ");
            //}
            //else
            //{
            //    for (int i = say2 + 1; i < say1; i++)
            //    {
            //        Console.Write(i + "\t");
            //    }
            //}
